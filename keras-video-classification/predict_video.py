...
input_file = "/Users/tom/Projects/bv-play-break-detection/data/Winners Beach Volleyball Court 1 04122020 Part 4/2614-play.mp4"
...
while True:
    ...
    i = np.argmax(results)
    print(results)
    label = "play" if results[0] > 0.5 else "break"
